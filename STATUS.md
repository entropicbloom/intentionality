...
| Allen training-pool size | `tp_pc_2M_n128_p{140,280,560,all}` (`train_pool=N`, pooledcross split 0, n=128) | reviewer's diversity confound: mixed populations from a pool as small as one mouse | p280 40.5°, p560 40.7° (near chance; full pool ~6,700: 35° at n=256, n=128 `pall` running); p140 crashed (sampling) -> the single-animal failure on Allen is largely training diversity, not the circuit; Allen text and discussion to be reworded |
