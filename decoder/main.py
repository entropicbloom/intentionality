...
pytorch_model = SetTransformer(dim_input=51, num_outputs=1, dim_output=10, num_inds=16, dim_hidden=32, num_heads=4, ln=False)

lightning_model = LightningModel(pytorch_model, learning_rate=0.001, num_classes=10)
data_module = OneLayerDataModule(model_type, dataset_type, layer_idx=2, input_dim=51, batch_size=128, num_workers=0)
